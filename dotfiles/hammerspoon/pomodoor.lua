--- Pomodoro module
-- Originaly downloaded from https://github.com/ztomer/.hammerspoon
...
hs.hotkey.bind({"cmd", "shift", "ctrl"}, '[', function() pom_enable() end)
hs.hotkey.bind({"cmd", "shift", "ctrl"}, ']', function() pom_disable() end)
